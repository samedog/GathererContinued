...
private.frame = CreateFrame("Frame", "GathererReportFrame", UIParent, "BackdropTemplate")
...
local frameSetBackdrop = {
		bgFile = "Interface/Tooltips/UI-Tooltip-Background",
		edgeFile = "Interface/Tooltips/UI-Tooltip-Border",
		tile = true, tileSize = 32, edgeSize = 16,
		insets = { left = 5, right = 5, top = 5, bottom = 5 }
	}
frame:SetBackdrop(frameSetBackdrop)
...
frame.Updater = CreateFrame("Button", "", UIParent, "ActionButtonTemplate")
local function OnUpdatefunc(self, delay) 
    private.UpdateHandler(delay) 
end
frame.Updater:SetScript("OnUpdate", OnUpdatefunc(self, delay) )

frame.Drag = CreateFrame("Button", "", frame, "ActionButtonTemplate")
...
frame.SearchBox = CreateFrame("EditBox", "", frame, "BackdropTemplate")
...
frame.SearchBox:SetBackdrop(SearchBoxSetBackdrop)
...
frame.Results = CreateFrame("Frame", "", frame, "BackdropTemplate")
...
frame.Results.Header = CreateFrame("Frame", "", frame, "BackdropTemplate")
...
for i=1, REPORT_LINES do
	local result = CreateFrame("Frame", "", frame, "BackdropTemplate")
...
frame.Actions = CreateFrame("Frame", "", frame, "BackdropTemplate")
