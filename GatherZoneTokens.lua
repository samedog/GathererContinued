...
local MapIdToTokenMap = {
  ...
  -- BfA
	-- KUL TIRAS
		[942] = "BFA_STORMSONG_VALLEY",
		[1039] = "BFA_SHRINE_OF_THE_STORMS",	-- STORMSONG VALLEY
		[895] = "BFA_TIRAGARDE_SOUND",
		[1161] = "BFA_BORALUS",			-- BORALUS
		[896] = "BFA_DRUSTVAR",
		[1169] = "BFA_TOLDAGOR",
	-- ZANDALAR
		[864] = "BFA_VOLDUN",
		[863] = "BFA_NAZMIR",
		[1041] = "BFA_UNDERROT",		-- NAZMIR
		[862] = "BFA_ZULDAZAR",
		[1165] = "BFA_DAZARNALOR",		-- ZULDAZAR
	-- BfA ARATHI HIGHLANDS
	-- BfA DARKSHORE
	-- BfA NASJATAR
	-- BfA MECHAGON ISLAND
		[1462] = "BFA_MECHAGON_ISLAND",
	-- BfA MISC
		[469] = "BFA_NEW_TINKERTOWN",		-- BfA DUN MOROGH
		[1577] = "BFA_GUILNEAS_CITY",		-- EASTERN KINGDOMS
		[202] = "BFA_GUILNEAS_CITY",		-- EASTERN KINGDOMS
		[1010] = "BFA_THE_MOTHERLODE",		-- KEZAN
		[998] = "BFA_UNDERCITY",		-- RUINS OF LORDAERON
		[1527] = "BFA_ULDUM",			-- KALIMDOR
    		[1339] = "BFA_WARSONG_GULCH",		-- NORTHERN BARRENS
